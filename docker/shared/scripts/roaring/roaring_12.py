...
def process_orders_parquet(file_path, batch_size=100000):
    ...
    return filtered_df, o_orderkey_index, o_orderpriority_index
...
if __name__ == "__main__":
    ...
    orders_filtered_df, o_orderkey_idx, o_orderpriority_idx = process_orders_parquet(orders_parquet)
    ...
    bitmap_size_mb = bitmap_memory_size(
        ...
        l_orderkey_idx, l_shipmode_idx, l_commitdate_idx, 
        l_receiptdate_idx, l_shipdate_idx
    )
