...
if __name__ == "__main__":
    ...
    con, sql_q8 = prepare_duckdb(filtered_orders, QUERY_PATH)
    engine_metrics_duck = measure_query_duckdb(8, con, sql_q8)
    ...
    ctx, sql_q8_df = prepare_datafusion(filtered_orders, QUERY_PATH)
    engine_metrics_df = measure_query_datafusion(8, ctx, sql_q8_df)
