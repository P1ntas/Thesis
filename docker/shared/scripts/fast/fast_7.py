...
END_DATE    = "1996-12-31"   
QUERY_PATH  = "../data/tpch/queries/7.sql"
...
if __name__ == "__main__":
    ...
    end_int   = date_to_int32(END_DATE)
    ...
    con, sql_q7 = prepare_duckdb(filtered_df, QUERY_PATH)
    engine_metrics_duck = measure_query_duckdb(7, con, sql_q7)
    ...
    ctx, sql_q7_df = prepare_datafusion(filtered_df, QUERY_PATH)
    engine_metrics_df = measure_query_datafusion(7, ctx, sql_q7_df)
